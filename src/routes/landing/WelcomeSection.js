    ...
    <article className="welcome-section" >
      <section className="section-2-info flex-container flex-column txt-center pop-font">
        ...
        <h2 className="txt-white">
          Welcome to <span>Pizztaurant</span> restaurant
        </h2>
        <p>
          Founded in 2021 we bring pizza slice by slice to the next level!
      ...
      <LazyLoadImage
        ...
        alt="Pizztaurant restaurant interior with people at the tabel and the staff serving the customers"
      />
    </article>
  )
}
