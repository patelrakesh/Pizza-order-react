  ...
  return (
    <article className="about-careers">
      <section className="content">
        ...
        <h3>Join the team</h3>
        <p>
          Are you passionate about great food, exceptional customer service, and working with a fun and dynamic team? If so, we would love to have you join our team at Pizztaurant!
